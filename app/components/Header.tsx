        ...
        <div className="container-site flex h-24 items-center justify-between">
          ...
          <div className="flex items-center gap-4 lg:hidden">
            <a
              ...
              className="flex size-11 items-center justify-center rounded-full bg-[var(--pink-soft)] text-[var(--pink)] shadow-[0_12px_30px_rgba(217,140,160,0.18)] transition-all duration-300 hover:bg-[var(--pink-light)]"
            >
              <svg
                viewBox="0 0 32 32"
                aria-hidden="true"
